from src.misc.result import Result
...
class Evaluator:
    def __init__(self, machine_list):
        ...
        self._handwritten_list = None
    
    @property
    def handwritten_list(self):
        return self._handwritten_list
    @handwritten_list.setter
    def handwritten_list(self, handwritten_list: str):
        self._handwritten_list = handwritten_list

    def run(self, recognized_words: list[dict], processing_time):
        """
            ...
            while i < len(target_list):
                ...
                if distance > len(target_list[i]) // 3:
                    ...
                    if distance_2 != -1 and distance_2 < distance:
                        ...
                        # print(word, matched_snippet, recognized_words)
        ...
        # Init Variablen
        letter_count_machine = sum(len(word) for word in self._machine_list)
        ...
        machine_list = self._machine_list.copy()
        ...
        result_data = {
            ...
            "word_count_machine": len(self._machine_list),
